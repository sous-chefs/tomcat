...
property :verify_checksum, [TrueClass, FalseClass], default: true, desired_state: false
property :dir_mode, String, default: '0750'
property :exclude_docs, [TrueClass, FalseClass], default: true, desired_state: false
property :exclude_examples, [TrueClass, FalseClass], default: true, desired_state: false
property :exclude_manager, [TrueClass, FalseClass], default: false, desired_state: false
property :exclude_hostmanager, [TrueClass, FalseClass], default: false, desired_state: false
...
property :tarball_validate_ssl, [TrueClass, FalseClass], default: true, desired_state: false
...
property :create_user, [TrueClass, FalseClass], default: true, desired_state: false
property :create_group, [TrueClass, FalseClass], default: true, desired_state: false
